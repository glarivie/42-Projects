...
<?php comment_id_fields(); ?>
				...
				<textarea id="comment" name="comment" class="form-control" row="3"  onfocus="if (this.value == '<?php _e( 'Commentaire', 'wpbx' ) ?>') {this.value = '';}" onblur="if (this.value == '') {this.value = '<?php _e( 'Commentaire', 'wpbx' ) ?>';}" rows="3"><?php _e( 'Commentaire', 'wpbx' ) ?></textarea>

				<button class="btn btn-primary" type="submit" id="submit" name="submit"><?php _e( 'Envoyer', 'wpbx' ) ?></button>
